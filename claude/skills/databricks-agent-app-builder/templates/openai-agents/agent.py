...
async def init_mcp_server():
    """Initialize the MCP server for tool access."""
    return McpServer(
...
def create_agent(mcp_server: McpServer) -> Agent:
    """Create the agent with MCP servers for tool access."""
    return Agent(
        name="assistant",
        instructions="You are a helpful assistant. You can execute code and answer questions.",
...
async def invoke(request: ResponsesAgentRequest) -> ResponsesAgentResponse:
    """Handle non-streaming inference requests."""
